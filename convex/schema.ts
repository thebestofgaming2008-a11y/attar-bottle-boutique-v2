...
export default defineSchema({
  ...
  products: defineTable({
    ...
    mood: optionalString,
    scent_profile: optionalString,
    hook: optionalString,
    story: optionalString,
    meaning: optionalString,
    key_notes: optionalStringArray,
    occasion: optionalString,
    intensity: optionalString,
    longevity: optionalString,
    volume_label: optionalString,
    format_label: optionalString,
    ...
    seo_keywords: optionalStringArray,
  ...
  orders: defineTable({
    ...
    refund_id: optionalString,
    refund_request_id: optionalString,
    refund_requested_at: optionalString,
    refund_reason: optionalString,
    refund_error: optionalString,
    refunded_at: optionalString,
    cancelled_at: optionalString,
    cancellation_reason: optionalString,
    returned_at: optionalString,
    return_reason: optionalString,
    inventory_restocked_at: optionalString,
    inventory_attention: optionalBoolean,
